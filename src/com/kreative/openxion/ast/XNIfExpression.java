...
public class XNIfExpression extends XNExpression {
	...
	public XNExpression trueCase;
	public XNToken elseToken;
	public XNExpression falseCase;
	...
	public int getBeginLine() {
		return ifToken.beginLine;
	}

	public int getEndCol() {
		return falseCase.getEndCol();
	}

	public int getEndLine() {
		return falseCase.getEndLine();
	}

	public String toString() {
		return "if "+condition+" then "+trueCase+" else "+falseCase;
	}
}
