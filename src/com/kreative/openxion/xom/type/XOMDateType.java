...
public class XOMDateType extends XOMPrimitiveDataType<XOMDate> {
	private static final long serialVersionUID = 1L;
	
	public static final XOMDateType instance = new XOMDateType();
	public static final XOMListType listInstance = new XOMListType("dates", DESCRIBABILITY_OF_PRIMITIVES, instance);
