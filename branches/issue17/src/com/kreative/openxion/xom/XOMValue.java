...
/**
 * XOMPrimitiveValue is the recommended base class for a primitive value in XION.
 * @since OpenXION 1.3
 * @author Rebecca G. Bettencourt, Kreative Software
 */
public abstract class XOMValue extends XOMVariant {
	...
	public final boolean canGetParent(XNContext ctx) { return false; }
	public final XOMVariant getParent(XNContext ctx) { throw new XNScriptError("Can't understand this"); }
	
	public final boolean canDelete(XNContext ctx) { return false; }
	public final void delete(XNContext ctx) { throw new XNScriptError("Can't understand this"); }
	...
	public final boolean canSetProperty(XNContext ctx, String property) { return false; }
	public final void setProperty(XNContext ctx, String property, XOMVariant value) { throw new XNScriptError("Can't understand this"); }
}
