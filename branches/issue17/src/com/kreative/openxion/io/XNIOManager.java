...
/**
 * An XNIOManager is responsible for managing input and output
 * through the open, read, write, and close commands for a
 * particular kind of XOMVariant.
 * @since OpenXION 1.0
 * @author Rebecca G. Bettencourt, Kreative Software
 */
public interface XNIOManager {
