...
public class XOMVariableMap {
	...
	public void declareVariable(XNContext ctx, String name) {
		CIString ciname = new CIString(name);
		types.put(ciname, XOMStringType.instance);
		values.put(ciname, XOMString.EMPTY_STRING);
	}
	
	public void declareVariable(XNContext ctx, String name, XOMDataType<? extends XOMVariant> type) {
		CIString ciname = new CIString(name);
		types.put(ciname, type);
		values.put(ciname, type.makeInstanceFrom(ctx, XOMEmpty.EMPTY));
	}
	
	public void declareVariable(XNContext ctx, String name, XOMVariant value) {
		CIString ciname = new CIString(name);
		types.put(ciname, XOMStringType.instance);
		values.put(ciname, new XOMString(value.toTextString(ctx)));
	}
	
	public void declareVariable(XNContext ctx, String name, XOMDataType<? extends XOMVariant> type, XOMVariant value) {
		CIString ciname = new CIString(name);
		types.put(ciname, type);
	...
	public void prependVariable(XNContext ctx, String name, XOMVariant value) {
		CIString ciname = new CIString(name);
		if (!types.containsKey(ciname)) types.put(ciname, XOMStringType.instance);
		values.put(ciname, types.get(ciname).makeInstanceFrom(ctx, value.asValue(ctx), values.get(ciname).asGiven()));
	}
	
	public void appendVariable(XNContext ctx, String name, XOMVariant value) {
		CIString ciname = new CIString(name);
		if (!types.containsKey(ciname)) types.put(ciname, XOMStringType.instance);
		values.put(ciname, types.get(ciname).makeInstanceFrom(ctx, values.get(ciname).asGiven(), value.asValue(ctx)));
	}
