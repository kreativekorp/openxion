...
public class XNUnaryExpression extends XNExpression {
	private static final long serialVersionUID = 101L;
	public XNToken operatorToken;
	public XNOperator operator;
	public XNExpression argument;
	
	public XNUnaryExpression(XNToken optk, XNOperator op, XNExpression a) {
	...
	public int getBeginCol() {
		return operatorToken.beginColumn;
	}
	
	public int getEndLine() {
		return argument.getEndLine();
	}
	
	public int getEndCol() {
		return argument.getEndCol();
	}
