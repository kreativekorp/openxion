...
public class XNBinaryExpression extends XNExpression {
	private static final long serialVersionUID = 102L;
	public XNExpression left;
	public XNOperator operator;
	public XNExpression right;
	
	public XNBinaryExpression(XNExpression l, XNOperator op, XNExpression r) {
