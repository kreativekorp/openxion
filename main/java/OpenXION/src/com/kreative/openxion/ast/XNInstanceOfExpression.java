...
public class XNInstanceOfExpression extends XNExpression {
	...
	public XNInstanceOfExpression(XNExpression a, XNOperator op, XNDataType dt, XNToken[] dttk) {
