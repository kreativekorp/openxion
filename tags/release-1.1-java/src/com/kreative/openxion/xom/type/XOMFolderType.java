...
public class XOMFolderType extends XOMDataType<XOMFile> {
	...
	public XOMVariant getMassInstance(XNContext ctx) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolders"))
	...
	public boolean canGetInstanceByIndex(XNContext ctx, int startIndex, int endIndex) {
		return ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "StartIndex", Integer.toString(startIndex), "EndIndex", Integer.toString(endIndex));
	}
	public boolean canGetInstanceByName(XNContext ctx, String name) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Name", name)) return false;
	...
	public XOMVariant getInstanceByName(XNContext ctx, String name) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Name", name))
			throw new XNScriptError("Security settings do not allow file system access");
		File theFile = new File(name);
	...
	public boolean canCreateInstanceByName(XNContext ctx, String name) {
		return ctx.allow(XNSecurityKey.FILE_SYSTEM_WRITE, "Operation", "MkDir", "Name", name);
	}
	public XOMVariant createInstanceByName(XNContext ctx, String name) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_WRITE, "Operation", "MkDir", "Name", name))
			throw new XNScriptError("Security settings do not allow file system access");
		try {
	...
	public boolean canGetChildMassVariant(XNContext ctx, XOMVariant parent) {
		return (ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolders", "Parent", parent.toDescriptionString()) && XOMFolderType.instance.canMakeInstanceFrom(ctx, parent));
	}
	public XOMVariant getChildMassVariant(XNContext ctx, XOMVariant parent) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolders", "Parent", parent.toDescriptionString()))
			throw new XNScriptError("Security settings do not allow file system access");
	...
	public boolean canGetChildVariantByIndex(XNContext ctx, XOMVariant parent, int index) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Parent", parent.toDescriptionString(), "Index", Integer.toString(index))) return false;
	...
	public boolean canGetChildVariantByIndex(XNContext ctx, XOMVariant parent, int startIndex, int endIndex) {
		return ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Parent", parent.toDescriptionString(), "StartIndex", Integer.toString(startIndex), "EndIndex", Integer.toString(endIndex));
	}
	public boolean canGetChildVariantByName(XNContext ctx, XOMVariant parent, String name) {
		if (ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Parent", parent.toDescriptionString(), "Name", name) && XOMFolderType.instance.canMakeInstanceFrom(ctx, parent)) {
			File theDir = XOMFolderType.instance.makeInstanceFrom(ctx, parent).toFile();
	...
	public XOMVariant getChildVariantByIndex(XNContext ctx, XOMVariant parent, int index) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Parent", parent.toDescriptionString(), "Index", Integer.toString(index)))
			throw new XNScriptError("Security settings do not allow file system access");
		List<? extends XOMVariant> theXFiles = getChildMassVariant(ctx, parent).toList(ctx);
		index = XIONUtil.index(1, theXFiles.size(), index, index)[0];
		if (index >= 1 && index <= theXFiles.size()) {
	...
	public XOMVariant getChildVariantByIndex(XNContext ctx, XOMVariant parent, int startIndex, int endIndex) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Parent", parent.toDescriptionString(), "StartIndex", Integer.toString(startIndex), "EndIndex", Integer.toString(endIndex)))
			throw new XNScriptError("Security settings do not allow file system access");
		List<? extends XOMVariant> theXFiles = getChildMassVariant(ctx, parent).toList(ctx);
		int[] indexes = XIONUtil.index(1, theXFiles.size(), startIndex, endIndex);
		if (indexes[0] < 1) indexes[0] = 1;
	...
	public XOMVariant getChildVariantByName(XNContext ctx, XOMVariant parent, String name) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_READ, "Operation", "GetFolder", "Parent", parent.toDescriptionString(), "Name", name))
			throw new XNScriptError("Security settings do not allow file system access");
		if (XOMFolderType.instance.canMakeInstanceFrom(ctx, parent)) {
			File theDir = XOMFolderType.instance.makeInstanceFrom(ctx, parent).toFile();
			File theFile = new File(theDir, name);
	...
	public boolean canCreateChildVariantByName(XNContext ctx, XOMVariant parent, String name) {
		return (ctx.allow(XNSecurityKey.FILE_SYSTEM_WRITE, "Operation", "MkDir", "Parent", parent.toDescriptionString(), "Name", name) && XOMFolderType.instance.canMakeInstanceFrom(ctx, parent));
	}
	public XOMVariant createChildVariantByName(XNContext ctx, XOMVariant parent, String name) {
		if (!ctx.allow(XNSecurityKey.FILE_SYSTEM_WRITE, "Operation", "MkDir", "Parent", parent.toDescriptionString(), "Name", name))
			throw new XNScriptError("Security settings do not allow file system access");
		if (XOMFolderType.instance.canMakeInstanceFrom(ctx, parent)) {
			try {
				File theDir = XOMFolderType.instance.makeInstanceFrom(ctx, parent).toFile();
