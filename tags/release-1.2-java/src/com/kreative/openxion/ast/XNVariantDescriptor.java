...
public abstract class XNVariantDescriptor extends XNExpression {
	private static final long serialVersionUID = 1000L;

	public XNToken[] dtTokens;
	...
	public final int getBeginCol() {
		return internalGetBeginCol();
	}
	
	public final int getEndLine() {
		return (parentVariant != null) ? parentVariant.getEndLine() : internalGetEndLine();
	}
	
	public final int getEndCol() {
		return (parentVariant != null) ? parentVariant.getEndCol() : internalGetEndCol();
	}
	
	public final String toString() {
		String s = internalToString();
