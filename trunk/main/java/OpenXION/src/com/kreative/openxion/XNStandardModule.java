...
public class XNStandardModule extends XNModule {
	...
	private static void put(XNInterpreter interp, XNContext ctx, XOMVariant what, String prep, XOMVariant dest) {
		if (dest.canPutContents(ctx)) {
	...
	private static void put(XNInterpreter interp, XNContext ctx, XOMVariant what, String prep, XOMVariant dest, String prop, XOMVariant pval) {
		if (dest.canPutContents(ctx)) {
	...
	private static List<XOMVariant> anyNumericListParameter(XNContext ctx, String functionName, XOMVariant parameter) {
		...
		if (XOMIntegerType.listInstance.canMakeInstanceFrom(ctx, parameter)) {
			...
			return (XOMComplexType.listInstance.makeInstanceFrom(ctx, parameter)).toList(ctx);
		}
		else {
