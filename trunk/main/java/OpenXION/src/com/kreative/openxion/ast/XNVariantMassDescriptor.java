...
public class XNVariantMassDescriptor extends XNVariantDescriptor {
	...
	protected int internalGetBeginLine() {
		if (allToken != null) return allToken.beginLine;
		else if (theToken != null) return theToken.beginLine;
	...
	protected int internalGetEndCol() {
		...
		else if (allToken != null) return allToken.endColumn;
		else return 0;
	}
	...
	protected int internalGetEndLine() {
		...
		else if (allToken != null) return allToken.endLine;
		else return 0;
	}
