...
public class XNVariantIdDescriptor extends XNVariantDescriptor {
	...
	protected int internalGetBeginCol() {
		...
		else if (id != null) return id.getBeginCol();
		else return 0;
	}
	...
	protected int internalGetBeginLine() {
		...
		else if (id != null) return id.getBeginLine();
		else return 0;
	}
	
	protected int internalGetEndCol() {
		if (id != null) return id.getEndCol();
	...
	protected int internalGetEndLine() {
		if (id != null) return id.getEndLine();
